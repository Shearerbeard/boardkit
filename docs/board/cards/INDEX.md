...
| [S32](s32-artifact-store-adr.md) | ArtifactStore ADR - receipts, postures, sidecar mechanics | in-review | S28 | smart | S -> A -> D -> U @ A |
...
- [S41](s41-co-worker-consumption.md) Co-worker consumption readiness - 3/12 done - S8 (ready), S12 (ready), S15 (done), S30 (done), S31 (done), S32 (in-review), S33 (backlog), S36 (backlog), S37 (backlog), S38 (ready), S39 (ready), S40 (ready)
