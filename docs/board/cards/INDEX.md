...
| [S28](s28-store-seam-wiring.md) | Wire the CLI core through the CardStore seam | done | - | smart | S -> A -> D -> U(code-review) |
...
| [S33](s33-receipts-and-sidecar.md) | Receipts and sidecar implementation per the ADR | done | S32 | smart | S -> A -> M -> D -> U(code-review) |
...
| [S39](s39-machine-bootstrap-recipe.md) | Machine-bootstrap recipe and account inventory | in-review | - | smart | S -> A -> U(code-review) -> D -> U @ D |
...
- [S41](s41-co-worker-consumption.md) Co-worker consumption readiness - 7/15 done - S8 (ready), S12 (ready), S15 (done), S30 (done), S31 (done), S32 (done), S33 (done), S36 (backlog), S37 (backlog), S38 (ready), S39 (in-review), S40 (ready), S46 (done), S48 (ready), S49 (done)
