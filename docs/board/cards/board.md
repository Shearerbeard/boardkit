...
- [ ] **S39** [Machine-bootstrap recipe and account inventory](s39-machine-bootstrap-recipe.md)
	Depends: none. Gates: S -> A -> U(code-review) -> D -> U @ U. Executor: smart.
...
- [ ] **S47** [model-class tags in the rust-holes dispatch brief](s47-rust-holes-brief-class-tags.md)
	Depends: none. Gates: S -> A. Executor: any.
- [ ] **S49** [Pre-publication docs pass - feedback intake to issues, bus test, publish-gate rulings](s49-prepublication-docs-pass.md)
	Depends: none. Gates: S -> A. Executor: any.
