...
license: MIT OR Apache-2.0 (rust-lang/book, LICENSE-MIT / LICENSE-APACHE)
note: Chapter opening through the stack-and-heap aside and the three ownership rules; user-named canonical clean technical writing. Fetched verbatim from the book's markdown source (rust-lang/book src/ch04-01-what-is-ownership.md).
---
